package com.dzl.duanzil.core.vp
...
import com.tidycar.carzki.ui.view.vp.ColorFlipPagerTitleView
...
//        if (!isIndicator) return null
        ...
        indicator.setColors(ResourcesCompat.getColor(context.resources, R.color.skin_primary, null))
